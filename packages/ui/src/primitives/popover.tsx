      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className={cn(
              "w-72 p-4 shadow-md backdrop-blur-lg relative z-50 origin-(--radix-popover-content-transform-origin) rounded-md border bg-background/80 text-popover-foreground outline-hidden",
              className,
            )}
          >
            {children}
