...
export function WindowsServer1825Icon(props: ComponentProps<"svg">) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4875 4875">
      <path
        fill="#0078d4"
...
export function WindowsServer1218Icon(props: ComponentProps<"svg">) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87.35 87.6">
      <path
...
export function WindowsServer0612Icon(props: ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -0.03 170.33 150.27"
    >
      <path
