    ...
    <div className="flex">
      <Popover open={isPopoverOpen} onOpenChange={setPopoverOpen}>
        <PopoverTrigger asChild>
          <div className="flex">
            <IconButton selected={isPopoverOpen} onClick={() => null}>
              <Folder
        ...
        >
          <div className="flex flex-col">
            <div className="gap-2 p-2 flex items-center border-b">
              <div className="relative flex-1">
                <Search className="left-2 size-4 absolute top-1/2 -translate-y-1/2 opacity-60" />
                <input
                  ref={searchRef}
                  value={query}
            ...
            <div className="relative" onKeyDown={handleKey}>
              <AnimatePresence custom={dir} mode="popLayout">
                <ul
                  key={path.join("/") + "|" + query}
                  className="max-h-72 py-1 overflow-auto"
                  role="listbox"
                  aria-label="Folders"
                >
                  {list.length === 0 && (
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className={cn(
                              "gap-2 px-3 py-2 text-sm flex w-full items-center justify-between transition-colors",
              ...
              <div className="gap-1.5 pr-2 pb-2 flex items-center justify-end">
                {path.length > 0 && (
                  <ButtonWithKbd
                    onClick={goUp}
            ...
            <div className="p-2 flex items-center justify-end border-t">
              <ButtonWithKbd
